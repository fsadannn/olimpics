...
def add_data(df,tag, year = "2019"):
    for idx, i in df.iterrows():
        names = ["Athlete 1","Athlete 2", "Athlete 3", "Athlete 4"]    
        for index, name in enumerate(names):
            ...
            athletes[i[name]][year][tag]["1000"]            = str(i["1000"])
            athletes[i[name]][year][tag]["2000"]            = str(i["2000"])
            athletes[i[name]][year][tag]["3000"]            = str(i["3000"])
            athletes[i[name]][year][tag]["total"]           = str(i["total"])
            athletes[i[name]][year][tag]["1000-2000"]       = str(i["1000-2000"])
            athletes[i[name]][year][tag]["2000-3000"]       = str(i["2000-3000"])
            athletes[i[name]][year][tag]["3000-4000"]       = str(i["3000-4000"])
...
df = pd.read_csv("2020/Qualifications.csv", sep=",")
...
df = pd.read_csv("2019/Qualifications.csv", sep=",")
