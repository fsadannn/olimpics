...
df = pd.read_csv("2019/WomenSprintQualif.csv", sep=";")
...
df = pd.read_csv("2019/WomenSprint16.csv", sep=";")
add_data(df, "sixteenth")

df = pd.read_csv("2019/WomenSprint8.csv", sep=";")
add_data(df, "eighth")


df = pd.read_csv("2019/WomenSprint4.csv", sep=";")
add_data(df, "quarter")

df = pd.read_csv("2019/WomenSprint2.csv", sep=";")
add_data(df, "semi")

df = pd.read_csv("2019/WomenSprint.csv", sep=";")
add_data(df, "final")

df = pd.read_csv("2020/WomenSprintQualif.csv", sep=";")
...
df = pd.read_csv("2020/WomenSprint16.csv", sep=",")
add_data(df, "sixteenth", "2020")

df = pd.read_csv("2020/WomenSprint8.csv", sep=";")
add_data(df, "eighth", "2020")


df = pd.read_csv("2020/WomenSprint4.csv", sep=";")
add_data(df, "quarter", "2020")

df = pd.read_csv("2020/WomenSprint2.csv", sep=";")
add_data(df, "semi", "2020")

df = pd.read_csv("2020/WomenSprint.csv", sep=";")
add_data(df, "final", "2020")

with open("women_sprint.json", "w") as f:
